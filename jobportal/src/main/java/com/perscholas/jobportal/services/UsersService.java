package com.perscholas.jobportal.services;


import com.perscholas.jobportal.entity.JobSeekerProfile;
import com.perscholas.jobportal.entity.RecruiterProfile;
import com.perscholas.jobportal.entity.Users;
import com.perscholas.jobportal.repository.JobSeekerProfileRepository;
import com.perscholas.jobportal.repository.RecruiterProfileRepository;
import com.perscholas.jobportal.repository.UsersRepository;
    ...
    public Object getCurrentUserProfile() {
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            Users users = usersRepository.findByEmail(username).orElseThrow(() -> new
                    UsernameNotFoundException("User not found" + "user"));
