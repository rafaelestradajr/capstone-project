...
import com.perscholas.jobportal.services.*;
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))){
               ...
               JobSeekerProfile user = jobSeekerProfileService.getCurrentSeekerProfile();
                if (user !=null){
                    ...
                    for(JobSeekerSave jobSeekersSave : jobSeekerSaveList){
                        if(Objects.equals(jobSeekersSave.getUserId().getUserAccountId(), user.getUserAccountId())){
                            saved = true;
                            break;
                        }
                    }
